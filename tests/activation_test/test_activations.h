...
private:
    void test_relu_activation() {
        ...
        try {
            ...
            assert(is_close(output_mixed(0, 0), 0.0f));
            assert(is_close(output_mixed(0, 1), 0.0f));
            assert(is_close(output_mixed(0, 2), 3.0f));
            assert(is_close(output_mixed(0, 3), 0.0f));
            assert(is_close(output_mixed(0, 4), 7.2f));
            assert(is_close(output_mixed(0, 5), 0.0f));
    ...
    void test_activation_backward_pass() {
        ...
        try {
            ...
            assert(is_close(grad_input_relu(0, 0), 0.0f));
            assert(is_close(grad_input_relu(0, 1), 0.0f));
            assert(is_close(grad_input_relu(0, 2), 1.0f));
            assert(is_close(grad_input_relu(0, 3), 0.0f));
            assert(is_close(grad_input_relu(0, 4), 1.0f));
            assert(is_close(grad_input_relu(0, 5), 0.0f));
